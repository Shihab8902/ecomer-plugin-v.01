        ...
        <div className="w-full mt-10 flex flex-col justify-center items-center ">
            ...
            <div className="p-3 w-fit rounded-lg shadow-xl flex gap-6 flex-col">
                ...
                <div className="w-full flex items-center flex-col h-full justify-end">
                    ...
                    <Link to="https://framer.com/projects/new?duplicate=y7nKoZJCd7roMdEXiGxM" target="_blank"><button onClick={() => navigate("/store/manage")} className="w-56 framer-button-primary h-8">Remix Template</button></Link>
